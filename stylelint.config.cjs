module.exports = {
  ...
  rules: {
    ...
    // Catch RGB values in custom properties - updated to allow HSL space-separated values
    'declaration-property-value-disallowed-list': [
      ...
      {
        message: 'RGB/Hex values not allowed in color custom properties. Use HSL format like "220 13% 91%" instead',
      },
    ],
